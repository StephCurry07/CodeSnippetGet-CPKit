...
import { Loader2, Copy, Share2, Download, Maximize2, Menu, Sun, Moon, Trash, X, Check } from "lucide-react"
...
export default function CodeSnippetSuggester() {
  ...
  const openFullscreenSnippet = () => {
    ...
    window.open(`snippet-generator/fullscreen-snippet?snippet=${encodedSnippet}&language=${encodedLanguage}`, '_blank')
  }
        ...
        <CardContent className="p-0">
          <ScrollArea className="h-[calc(100vh-5rem)]">
            {recentSnippets.map((snippet, index) => (
              <div key={snippet.id} className="p-1 group">
                <Button
                  variant="ghost"
                ...
                <button
                  ...
                  className="opacity-20 group-hover:opacity-100 transition-opacity duration-200"
